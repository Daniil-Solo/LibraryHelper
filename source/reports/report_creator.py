...
class ReportGenerator:
    ...
    def generate_and_save(self, title: str, headings_cells: list[str], data_cells: list[tuple[any]]) -> str:
        report = Report()
...
class Report(FPDF):
    ...
    def add_table(self, head_cells: list[str], data: list[tuple[any]]) -> None:
